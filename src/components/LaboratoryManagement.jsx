...
export default function LaboratoryManagement() {
  ...
  const handleMpesaDialogSubmit = async () => {
    ...
    if (!phoneInput) {
      Swal.fire({
        ...
        text: "Enter a phone number before sending M-Pesa prompt.",
      });
      return;
    }
    ...
    if (!mpesaDialog.billId || !mpesaDialog.orderId) {
      Swal.fire({
        icon: "error",
        title: "Missing bill",
        text: "No bill is linked to this payment.",
      });
      return;
    }
    ...
    try {
      ...
      pollForPaymentAndRefreshLab(mpesaDialog.orderId, {
        maxAttempts: 35,
        intervalMs: 2000,
      });
      setMpesaDialog((prev) => ({ ...prev, open: false }));
  ...
  const payWithMpesaForLabOrder = async () => {
    const order = orderView.order;
    // Debug: trace when Pay with M-Pesa is clicked for lab orders
    // eslint-disable-next-line no-console
    console.log("[Lab] payWithMpesaForLabOrder clicked", {
      hasToken: !!token,
      orderId: order?.id,
      currentBilling: orderBilling,
    });
    if (!requireTokenGuard() || !order?.id) {
      // eslint-disable-next-line no-console
      console.log("[Lab] payWithMpesaForLabOrder aborted: missing auth or order id");
      return;
    }

    // Ensure we have up-to-date billing for this lab order.
    // IMPORTANT: we cannot rely on state immediately after setOrderBilling, so we fetch here and use the response directly.
    let billing = orderBilling;
    if (!billing?.bill_id) {
      // eslint-disable-next-line no-console
      console.log("[Lab] payWithMpesaForLabOrder: fetching billing via /billing/by-reference");
      try {
        const qs = new URLSearchParams({
          item_type: "lab_order",
          reference_id: String(order.id),
        ...
        billing = data?.data || null;
        setOrderBilling(billing);
      } catch (e) {
        // eslint-disable-next-line no-console
        console.log("[Lab] payWithMpesaForLabOrder: error fetching billing", e);
        billing = null;
        setOrderBilling(null);
      }
    }
    ...
    if (!billing?.bill_id) {
      // eslint-disable-next-line no-console
      console.log("[Lab] payWithMpesaForLabOrder: no bill_id after loadOrderBilling");
      Swal.fire({
        icon: "error",
        title: "No bill found",
        text: "Could not find billing for this lab order. Create or refresh billing first.",
      });
      return;
    }
    ...
    const defaultAmount = String(billing?.balance ?? billing?.total_amount ?? "0");
    setMpesaDialog({
      open: true,
      phone: initialPhone,
          ...
          >
            ...
            >
              <Button
                ...
                onClick={() => navigate("/laboratory/kenya-lab-tests")}
                sx={{
              ...
              {isSuperAdmin && tab === 0 && (
                <Button
                  variant="contained"
                  startIcon={<Add />}
                  onClick={() => navigate("/laboratory/create-lab-test")}
                  sx={{
                    width: { xs: "100%", sm: "auto" },
                    bgcolor: "rgba(255,255,255,0.15)",
                    color: "white",
                ...
                <Table size="small" sx={{ tableLayout: "fixed", width: "100%", minWidth: "100%" }}>
                  <TableHead>
                    <TableRow sx={{ bgcolor: "rgba(0, 137, 123, 0.06)" }}>
                      ...
                      <TableCell sx={{ fontWeight: 800, width: { xs: "55%", sm: 160, md: 220 }, minWidth: 0, overflow: { xs: "hidden", md: "visible" }, textOverflow: { xs: "ellipsis", md: "clip" }, whiteSpace: { xs: "nowrap", md: "normal" } }}>Name</TableCell>
                      <TableCell sx={{ fontWeight: 800, display: { xs: "none", sm: "table-cell" }, width: { sm: 100 }, minWidth: 0, overflow: { xs: "hidden", md: "visible" }, textOverflow: { xs: "ellipsis", md: "clip" }, whiteSpace: { xs: "nowrap", md: "normal" } }}>Code</TableCell>
                      <TableCell sx={{ fontWeight: 800, display: { xs: "none", md: "table-cell" }, width: { md: 90 }, minWidth: 0, overflow: { xs: "hidden", md: "visible" }, textOverflow: { xs: "ellipsis", md: "clip" }, whiteSpace: { xs: "nowrap", md: "normal" } }}>Price</TableCell>
                      <TableCell align="right" sx={{ fontWeight: 800, width: { xs: "30%", sm: 120 }, minWidth: 0, overflow: { xs: "hidden", md: "visible" }, textOverflow: { xs: "ellipsis", md: "clip" }, whiteSpace: { xs: "nowrap", md: "normal" } }}>
                        Actions
                      </TableCell>
                    </TableRow>
                  </TableHead>
                    ...
                    {testLoading ? (
                      ...
                      tests.map((t, idx) => (
                        ...
                        >
                          ...
                          <TableCell sx={{ fontWeight: 800, maxWidth: { xs: "28vw", sm: 160, md: 220 }, minWidth: 0, overflow: { xs: "hidden", md: "visible" }, textOverflow: { xs: "ellipsis", md: "clip" }, whiteSpace: { xs: "nowrap", md: "normal" } }}>
                            {t.test_name}
                          </TableCell>
                ...
                <Table size="small" sx={{ tableLayout: "fixed", width: "100%", minWidth: "100%" }}>
                  <TableHead>
                    <TableRow sx={{ bgcolor: "rgba(0, 137, 123, 0.06)" }}>
                      ...
                      <TableCell sx={{ fontWeight: 800, display: { xs: "none", md: "table-cell" }, width: { md: 100 }, minWidth: 0, overflow: { xs: "hidden", md: "visible" }, textOverflow: { xs: "ellipsis", md: "clip" }, whiteSpace: { xs: "nowrap", md: "normal" } }}>Created</TableCell>
                      ...
                      <TableCell sx={{ fontWeight: 800, display: { xs: "none", md: "table-cell" }, width: { md: 120 }, minWidth: 0, overflow: { xs: "hidden", md: "visible" }, textOverflow: { xs: "ellipsis", md: "clip" }, whiteSpace: { xs: "nowrap", md: "normal" } }}>Doctor</TableCell>
                      ...
                      <TableCell sx={{ fontWeight: 800, display: { xs: "none", md: "table-cell" }, width: { md: 120 }, minWidth: 0, overflow: { xs: "hidden", md: "visible" }, textOverflow: { xs: "ellipsis", md: "clip" }, whiteSpace: { xs: "nowrap", md: "normal" } }}>Tests</TableCell>
                ...
                <Table size="small" sx={{ tableLayout: "fixed", width: "100%", minWidth: "100%" }}>
                  <TableHead>
                    <TableRow sx={{ bgcolor: "rgba(0, 137, 123, 0.06)" }}>
                      ...
                      <TableCell sx={{ fontWeight: 800, width: { xs: "60%", sm: 140, md: 220 }, minWidth: 0, overflow: { xs: "hidden", md: "visible" }, textOverflow: { xs: "ellipsis", md: "clip" }, whiteSpace: { xs: "nowrap", md: "normal" } }}>Patient</TableCell>
                      <TableCell sx={{ fontWeight: 800, display: { xs: "none", md: "table-cell" }, width: { md: 80 }, minWidth: 0, overflow: { xs: "hidden", md: "visible" }, textOverflow: { xs: "ellipsis", md: "clip" }, whiteSpace: { xs: "nowrap", md: "normal" } }}>Total</TableCell>
                      <TableCell sx={{ fontWeight: 800, display: { xs: "none", md: "table-cell" }, width: { md: 80 }, minWidth: 0, overflow: { xs: "hidden", md: "visible" }, textOverflow: { xs: "ellipsis", md: "clip" }, whiteSpace: { xs: "nowrap", md: "normal" } }}>Paid</TableCell>
                      <TableCell sx={{ fontWeight: 800, display: { xs: "none", md: "table-cell" }, width: { md: 80 }, minWidth: 0, overflow: { xs: "hidden", md: "visible" }, textOverflow: { xs: "ellipsis", md: "clip" }, whiteSpace: { xs: "nowrap", md: "normal" } }}>Balance</TableCell>
                      <TableCell sx={{ fontWeight: 800, display: { xs: "none", sm: "table-cell" }, width: { sm: 100 }, minWidth: 0, overflow: { xs: "hidden", md: "visible" }, textOverflow: { xs: "ellipsis", md: "clip" }, whiteSpace: { xs: "nowrap", md: "normal" } }}>Status</TableCell>
                      <TableCell sx={{ fontWeight: 800, display: { xs: "none", md: "table-cell" }, width: { md: 100 }, minWidth: 0, overflow: { xs: "hidden", md: "visible" }, textOverflow: { xs: "ellipsis", md: "clip" }, whiteSpace: { xs: "nowrap", md: "normal" } }}>Created</TableCell>
                      <TableCell align="right" sx={{ fontWeight: 800, width: { xs: "25%", sm: 120 }, minWidth: 0, overflow: { xs: "hidden", md: "visible" }, textOverflow: { xs: "ellipsis", md: "clip" }, whiteSpace: { xs: "nowrap", md: "normal" } }}>Actions</TableCell>
                    </TableRow>
                  </TableHead>
                  <TableBody>
                    {labBillsLoading ? (
              ...
              >
                <Table size="small" sx={{ tableLayout: "fixed", width: "100%", minWidth: "100%" }}>
                  <TableHead>
                    <TableRow sx={{ bgcolor: "rgba(0, 137, 123, 0.06)" }}>
                      <TableCell sx={{ fontWeight: 800, width: { xs: "15%", sm: 64 }, minWidth: 0, overflow: { xs: "hidden", md: "visible" }, textOverflow: { xs: "ellipsis", md: "clip" }, whiteSpace: { xs: "nowrap", md: "normal" } }}>No</TableCell>
                      <TableCell sx={{ fontWeight: 800, display: { xs: "none", md: "table-cell" }, width: { md: 110 }, minWidth: 0, overflow: { xs: "hidden", md: "visible" }, textOverflow: { xs: "ellipsis", md: "clip" }, whiteSpace: { xs: "nowrap", md: "normal" } }}>Date</TableCell>
                      <TableCell sx={{ fontWeight: 800, width: { xs: "60%", sm: 140, md: 220 }, minWidth: 0, overflow: { xs: "hidden", md: "visible" }, textOverflow: { xs: "ellipsis", md: "clip" }, whiteSpace: { xs: "nowrap", md: "normal" } }}>Patient</TableCell>
          ...
          <Stack spacing={2}>
            ...
            <TableContainer sx={{ overflowX: "auto", width: "100%" }}>
              <Table size="small" sx={{ tableLayout: "fixed", width: "100%", minWidth: "100%" }}>
                <TableHead>
                  <TableRow>
                    <TableCell sx={{ fontWeight: 800, width: { xs: "40%", sm: 140, md: 220 }, minWidth: 0, overflow: { xs: "hidden", md: "visible" }, textOverflow: { xs: "ellipsis", md: "clip" }, whiteSpace: { xs: "nowrap", md: "normal" } }}>Test</TableCell>
                    <TableCell sx={{ fontWeight: 800, display: { xs: "none", sm: "table-cell" }, width: { sm: 100 }, minWidth: 0, overflow: { xs: "hidden", md: "visible" }, textOverflow: { xs: "ellipsis", md: "clip" }, whiteSpace: { xs: "nowrap", md: "normal" } }}>Code</TableCell>
                    <TableCell sx={{ fontWeight: 800, width: { xs: "35%", sm: 120 }, minWidth: 0, overflow: { xs: "hidden", md: "visible" }, textOverflow: { xs: "ellipsis", md: "clip" }, whiteSpace: { xs: "nowrap", md: "normal" } }}>Result</TableCell>
                    <TableCell align="right" sx={{ fontWeight: 800, width: { xs: "25%", sm: 120 }, minWidth: 0, overflow: { xs: "hidden", md: "visible" }, textOverflow: { xs: "ellipsis", md: "clip" }, whiteSpace: { xs: "nowrap", md: "normal" } }}>
                      Action
                    </TableCell>
                  </TableRow>
